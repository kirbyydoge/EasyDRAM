#ifndef     RAMULATOR_FRONTEND_PROCESSOR_DEP_O3_LLC_H
#define     RAMULATOR_FRONTEND_PROCESSOR_DEP_O3_LLC_H
...
DECLARE_DEBUG_FLAG(DDEPO3LLC);
// ENABLE_DEBUG_FLAG(DDEPO3LLC);

class DEPO3LLC : public Clocked<DEPO3LLC> {
  friend class DEPO3;
  ...
  public:
    DEPO3LLC(int latency, int size_bytes, int linesize_bytes, int associativity, int num_mshrs, int num_cores);
...
#endif   // RAMULATOR_FRONTEND_PROCESSOR_DEP_O3_LLC_H