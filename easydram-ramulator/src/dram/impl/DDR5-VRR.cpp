...
class DDR5VRR : public IDRAM, public Implementation {
  ...
  public:
    ...
    inline static const std::map<std::string, std::vector<int>> timing_presets = {
      //   name         rate   nBL  nCL nRCD   nRP  nRAS   nRC   nWR  nRTP nCWL nPPD nCCDS nCCDS_WR nCCDS_WTR nCCDL nCCDL_WR nCCDL_WTR nRRDS nRRDL nFAW nRFC1 nRFC2 nRFCsb nREFI nREFSBRD nRFM1 nRFM2 nRFMsb nDRFMab nDRFMsb nVRR   nRC   nCS, tCK_ps
   ...
   ***********************************************/
    ...
    inline static const ImplLUT m_command_scopes = LUT (
      m_commands, m_levels, {
        ...
        {"VRR",   "bank"},   {"VRR_end",   "bank"}, {"ROWC", "bank"},
      }
    );
    ...
    inline static const ImplLUT m_request_translations = LUT (
      m_requests, m_commands, {
        {"read", "RD"}, {"write", "WR"}, {"rowclone", "ROWC"},
...
/************************************************
  ...
  private:
    ...
    void set_timing_vals() {
      ...
      m_timing_vals("nROWC") = 3 + m_timing_vals("nRC");
      std::cout << "[Ramulator::DDR5-VRR] nROWC: " << m_timing_vals("nROWC") << std::endl;
      ...
      populate_timingcons(this, {
          ...
          {.level = "rank", .preceding = {"ROWC"}, .following = {"PREA"}, .latency = V("nROWC")},          
          {.level = "rank", .preceding = {"PREA"}, .following = {"ACT", "VRR", "ROWC"}, .latency = V("nRP")},          
          /// RAS <-> REF
          ...
          {.level = "rank", .preceding = {"ROWC"}, .following = {"REFab", "RFMab", "DRFMab"}, .latency = V("nROWC")},          
          ...
          {.level = "rank", .preceding = {"REFab"}, .following = {"ACT", "VRR", "ROWC", "PREA", "REFab", "RFMab", "DRFMab", "REFsb", "RFMsb", "DRFMsb"}, .latency = V("nRFC1")},          
          {.level = "rank", .preceding = {"RFMab"}, .following = {"ACT", "VRR", "ROWC", "PREA", "REFab", "RFMab", "DRFMab", "REFsb", "RFMsb", "DRFMsb"}, .latency = V("nRFM1")},          
          {.level = "rank", .preceding = {"DRFMab"}, .following = {"ACT", "VRR", "ROWC", "PREA", "REFab", "RFMab", "DRFMab", "REFsb", "RFMsb", "DRFMsb"}, .latency = V("nDRFMab")},          
          ...
          /*** Bank ***/ 
          {.level = "bank", .preceding = {"ACT"}, .following = {"ACT", "VRR", "ROWC", "REFsb", "RFMsb", "DRFMsb"}, .latency = V("nRC")},  
          {.level = "bank", .preceding = {"VRR"}, .following = {"ACT", "VRR", "ROWC", "REFsb", "RFMsb", "DRFMsb"}, .latency = V("nVRR")},  
          {.level = "bank", .preceding = {"ROWC"}, .following = {"ACT", "VRR", "ROWC", "REFsb", "RFMsb", "DRFMsb"}, .latency = V("nROWC")},  
          ...
          {.level = "bank", .preceding = {"PRE", "PREsb"}, .following = {"ACT", "VRR", "ROWC", "REFsb", "RFMsb", "DRFMsb"}, .latency = V("nRP")},  
          ...
          {.level = "bank", .preceding = {"RDA"}, .following = {"ACT", "VRR", "ROWC", "REFsb", "RFMsb", "DRFMsb"}, .latency = V("nRTP") + V("nRP")},  
          {.level = "bank", .preceding = {"WRA"}, .following = {"ACT", "VRR", "ROWC", "REFsb", "RFMsb", "DRFMsb"}, .latency = V("nCWL") + V("nBL") + V("nWR") + V("nRP")},  
          ...
          {.level = "bank", .preceding = {"REFsb"},  .following = {"ACT", "VRR", "ROWC", "REFsb", "RFMsb", "DRFMsb"}, .latency = V("nRFCsb")},  
          {.level = "bank", .preceding = {"RFMsb"},  .following = {"ACT", "VRR", "ROWC", "REFsb", "RFMsb", "DRFMsb"}, .latency = V("nRFMsb")},  
          {.level = "bank", .preceding = {"DRFMsb"}, .following = {"ACT", "VRR", "ROWC", "REFsb", "RFMsb", "DRFMsb"}, .latency = V("nDRFMsb")},  
        }
      );
      #undef V
    ...
    void set_actions() {
      ...
      m_actions[m_levels["bank"]][m_commands["ROWC"]] = Lambdas::Action::Bank::ROWC<DDR5VRR>;
    };
    ...
    void set_preqs() {
      ...
      m_preqs[m_levels["bank"]][m_commands["ROWC"]] = Lambdas::Preq::Bank::RequireBankClosed<DDR5VRR>;
    ...
    void set_powers() {
      ...
      // m_powers[m_levels["bank"]][m_commands["ROWC"]]  = Lambdas::Power::Bank::ROWC<DDR5VRR>;
      ...
      // m_powers[m_levels["rank"]][m_commands["ROWC"]] = Lambdas::Power::Rank::ROWC<DDR5VRR>;
