...
/* EasySched */
unsigned long long int easydram_global_start, easydram_global_end;
unsigned long long int easydram_stat0_start, easydram_stat0_end;
unsigned long long int easydram_stat1_start, easydram_stat1_end;
unsigned long long int easydram_stat2_start, easydram_stat2_end;
unsigned long long int easydram_stat3_start, easydram_stat3_end;
unsigned long long int easydram_stat4_start, easydram_stat4_end;
unsigned long long int easydram_stat5_start, easydram_stat5_end;
...
void polybench_timer_start()
{
  ...
  // easydram_global_start = *globalCounter;
  // easydram_stat0_start = *statCounter0;
  // easydram_stat1_start = *statCounter1;
  // easydram_stat2_start = *statCounter2;
  // easydram_stat3_start = *statCounter3;
  // easydram_stat4_start = *statCounter4;
  // easydram_stat5_start = *statCounter5;
...
{
  // easydram_global_end = *globalCounter;
  // easydram_stat0_end = *statCounter0;
  // easydram_stat1_end = *statCounter1;
  // easydram_stat2_end = *statCounter2;
  // easydram_stat3_end = *statCounter3;
  // easydram_stat4_end = *statCounter4;
  // easydram_stat5_end = *statCounter5;
#ifndef POLYBENCH_CYCLE_ACCURATE_TIMER
...
# else
      printf("!#POLYRES#! ");
      printf("cycle:%ld ", polybench_c_end - polybench_c_start);
      printf("glcyc:%ld ", easydram_global_end - easydram_global_start);
      printf("stat0:%ld ", easydram_stat0_end - easydram_stat0_start);
      printf("stat1:%ld ", easydram_stat1_end - easydram_stat1_start);
      printf("stat2:%ld ", easydram_stat2_end - easydram_stat2_start);
      printf("stat3:%ld ", easydram_stat3_end - easydram_stat3_start);
      printf("stat4:%ld ", easydram_stat4_end - easydram_stat4_start);
      printf("stat5:%ld\n", easydram_stat5_end - easydram_stat5_start);
# endif
#endif
}
...
xmalloc(size_t alloc_sz)
{
  ...
  int err = easy_memallign (&ret, 4096, padded_sz);
  if (! ret || err)
    {
      fprintf (stderr, "[PolyBench] easy_memallign: cannot allocate memory");
      exit (1);
    }
